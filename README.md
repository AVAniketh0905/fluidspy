...
![Pytest](https://github.com/github/docs/actions/workflows/test_pytest.yml/badge.svg)
![Ruff](<[https](https://github.com/github/docs/actions/workflows/test_ruff.yml/badge.svg)>)
